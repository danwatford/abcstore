 ...
 */
public class FileSummaryMessage {
    private final UUID id;
    private final long creationEpoch;
    private final int size;

    /**
     * Construct a FileSummaryMessage representing a file in storage.
     *
     ...
     */
    public FileSummaryMessage(final UUID id, final long creationEpoch, final int size) {
        this.id = id;
