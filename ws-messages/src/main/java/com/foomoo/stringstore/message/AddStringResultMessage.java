 ...
 */
public class AddStringResultMessage {
    ...
    /**
     * Construct an AddStringResultMessage representing the result of adding a string to the string store.
     *
     ...
     */
    @JsonCreator
    public AddStringResultMessage(final UUID stringId, final UUID requestId, final String user, final boolean existingString) {
