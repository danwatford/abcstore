...
public class RequestSummaryMessage {
    ...
    /**
     * Create a RequestSummaryMessage representing a request to add a file to storage.
     *
     ...
     */
    public RequestSummaryMessage(final UUID id, final UUID fileId, final long epoch, final String user) {
        this.id = id;
        this.fileId = fileId;
        this.epoch = epoch;
        this.user = user;
