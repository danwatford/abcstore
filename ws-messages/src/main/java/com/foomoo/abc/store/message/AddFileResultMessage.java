 ...
 */
public class AddFileResultMessage {
    ...
    /**
     * Construct an AddFileResultMessage representing the result of adding a file to the file store.
     *
     ...
     */
    @JsonCreator
    public AddFileResultMessage(final UUID fileId, final UUID requestId, final String user, final boolean existingFile) {
        this.fileId = fileId;
